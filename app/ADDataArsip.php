            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('ADArsip/index');?>"> Kelola Data </a></li>
            ...
            <div class="modal-body">
                <form id="formTambahDA">
                    ...
                    <div class="form-group">
                        ...
                        <select id="status_arsp" name="status_arsp" required>
            ...
            <div class="modal-body">
                <form id="formEditDA">
                    ...
                    <div class="form-group">
                        ...
                        <select id="edit_status_arsp" name="status_arsp" required>
                            <option value=""> Pilih Status </option>
                            <option value="Aktif"> Aktif </option>
                            <option value="Tidak Aktif"> Tidak Aktif </option>
                        </select>
...
<script>
    ...
    function editDataDA() {
        ...
        fetch('/ADArsip/editDA/' + data.idarsp, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    function openDetailModal(judul_arsp, kat_arsp, idwp, nama_wp, idptgs, nama_ptgs, tgl_pembuatan, status_arsp) {
        ...
        fetch(`/ADPenyimpananArsip/detail/${idarsp}`)
            ...
            .then(data => {
                ...
                <p><strong> Kategori Arsip : </strong> ${kat_arsp}</p>
                <p><strong> ID Wajib Pajak : </strong> ${idwp}</p>
                <p><strong> Nama Wajib Pajak : </strong> ${nama_wp}</p>
                <p><strong> ID Petugas : </strong> ${idptgs}</p>
                <p><strong> Nama Petugas : </strong> ${nama_ptgs}</p>
                <p><strong> Tanggal Pembuatan : </strong> ${tgl_pembuatan}</p>
                <p><strong> Status Arsip : </strong> ${status_arsp}</p>
                `;
