...
use App\Models\PTPenyimpananArsipModel;
use App\Models\PTDataArsipModel; // Tambahkan model arsip
use CodeIgniter\API\ResponseTrait;

class PTPenyimpananArsip extends BaseController
{
    use ResponseTrait;
    ...
    {
        $this->pda = new PTPenyimpananArsipModel();
        $this->arsp = new PTDataArsipModel(); // Inisialisasi model arsip
    }
    ...
    public function index()
    {
        ...
        return view('PTPenyimpanan', $data);
    }
