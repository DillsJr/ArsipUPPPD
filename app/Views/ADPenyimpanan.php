            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('ADPenyimpananArsip/index');?>"> Penyimpanan
                                Data </a></li>
...
<script>
    ...
    function tambahPenyimpananDA() {
        ...
        fetch('/ADPenyimpananArsip/tambahPDA', {
                method: 'POST',
                headers: {
    ...
    function editPDA() {
        ...
        fetch('/ADPenyimpananArsip/editPDA/' + data.idpda, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    function konfirmasiHapus() {
        ...
        fetch('/ADPenyimpananArsip/hapusPDA/' + idpda, {
                method: 'DELETE'
            })
            .then(response => response.json())
            .then(data => {
