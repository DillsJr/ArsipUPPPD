    ...
    <section class="content">
        ...
        <div class="card">
                ...
                <table id="data-table">
                    <thead>
                        <tr>
                            ...
                            <th data-column="idlprn"> ID Laporan <span class="sort-indicator"></span></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning"
                                    onclick="openEditModal('<?= $lprn->idlprn ?>', '<?= $lprn->isi_lprn ?>', '<?= $lprn->idarsp ?>', '<?= $lprn->judul_arsp ?>', '<?= $lprn->idptgs ?>', '<?= $lprn->nama_ptgs ?>'), '<?= $lprn->nama_ptgs ?>'">
                                    Edit
                                </button> |
                                <button type="button" class="btn btn-danger" onclick="hapusLap('<?= $lprn->idlprn ?>')">
                                    Hapus
                                </button> |
            ...
            <div class="card-footer">
                ...
                <button type="button" class="btn btn-tool" onclick="downloadPDF()"> Unduh PDF </button> |
                <button type="button" class="btn btn-tool" onclick="downloadExcel()"> Unduh Excel </button>
            </div>
        </div>
    </section>
</div>
...
<script>
    ...
    function setPetugas(selectElement) {
        const selectedOption = selectElement.options[selectElement.selectedIndex];
        const petugasLaporan = selectedOption.getAttribute('data-petugas');
        if (selectElement.id === 'idptgs') {
            document.getElementById('nama_ptgs').value = petugasLaporan;
        } else {
            document.getElementById('edit_nama_ptgs').value = petugasLaporan;
        }
    }
    ...
    function openEditModal(idlprn, isi_lprn, idarsp, judul_arsp, idptgs, nama_ptgs) {
        ...
        var modal = new bootstrap.Modal(document.getElementById('modalEditLap'));
        modal.show();
    }
    ...
    function editLap() {
        ...
        fetch('/LDLaporan/editLap/' + data.idlprn, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    function konfirmasiHapus() {
        ...
        fetch('/LDLaporan/hapusLap/' + idlprn, {
                method: 'DELETE'
            })
            .then(response => response.json())
            .then(data => {
