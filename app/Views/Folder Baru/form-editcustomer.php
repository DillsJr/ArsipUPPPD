                ...
                <div class="form01">
                    <form>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <input type="text" name="cid" class="form-control" value="<?=$dt->cid?>"> 
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="#" class="col-sm-2 col-form-label">Name</label>
                            <div class="col-sm-10">
                            <input type="text" name="cname" class="form-control" value="<?=$dt->cname?>"> 
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <input type="text" name="phone" class="form-control" value="<?=$dt->phone?>"> 
                            </div>
                        </div>
