            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('PTWajibPajak/index');?>"> Kelola Data </a>
                        </li>
...
<script>
    ...
    function editDataWP() {
        ...
        fetch('/PTWajibPajak/editWP/' + data.idwp, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    function konfirmasiHapus() {
        ...
        fetch('/PTWajibPajak/hapusWP/' + idwp, {
                method: 'DELETE'
            })
            .then(response => response.json())
            .then(data => {
