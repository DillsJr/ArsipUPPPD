...
<aside class="main-sidebar sidebar-white elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
        <a href="<?= base_url('Roles/admin');?>"><img
        ...
        <div class="sidebar custom-navbar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('Roles/admin');?>" class="nav-link">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= base_url('ADWajibPajak/index');?>" class="nav-link">
                                    <i class="fas fa-arrow-right nav-icon"></i>
                                    <p> Data Wajib Pajak </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('ADArsip/index');?>" class="nav-link">
                                    <i class="fas fa-arrow-right nav-icon"></i>
                                    <p> Data Arsip </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('ADPetugas/index');?>" class="nav-link">
                                    <i class="fas fa-arrow-right nav-icon"></i>
                                    <p> Data Petugas </p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('ADPenyimpananArsip/index');?>" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('ADLaporan/index');?>" class="nav-link">
